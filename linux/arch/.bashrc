...
# Package management
alias update='sudo pacman -Syyu --noconfirm && sudo pacman -Rns $(pacman -Qtdq) --noconfirm'
alias installpkg='sudo pacman -S --noconfirm'
alias removepkg='sudo pacman -Rns --noconfirm'
